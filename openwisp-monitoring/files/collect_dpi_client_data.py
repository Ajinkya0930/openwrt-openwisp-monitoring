...
# Output file path (aggregated gzip JSON for this hour)
out_path = output_dir / f"dpi_summary_by_client_{hour_timestamp}.json.gz"

# If the file already exists for this hour, skip to avoid duplicates
if out_path.exists():
    print(f"Gzip file for this hour already exists: {out_path}")
    exit(0)
...
if results:
    # Save all collected data to gzip-compressed file
